...
import { heroSlider } from '../data.jsx';
...
const HeroSlider = () => {
  ...
  >
    {heroSlider.map((slide,index)=>{
      const {title,subtitle,id,image,buttonText} = slide;
          ...
          <div className=' flex flex-col justify-between
           items-center lg:flex-row'>
            ...
            <div className='flex-1'>
              <h1 className=' text-blue text-[36px] leading-tight
               lg:text-[72px] lg:leading-[98px] font-extrabold
                mb-4'>{title}</h1>
